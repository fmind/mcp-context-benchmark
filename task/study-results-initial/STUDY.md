...
Status: authorized for execution; no trials had run when this plan was frozen. Declared on 2026-09-21, before any inference on these cases. The original `PLAN.md`, runner, fixtures, and ten results remain historical evidence.
